<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-05-17 08:03:49
         compiled from "D:\xampp\htdocs\test\application\views\templates\partials\sidebar_left.html" */ ?>
<?php /*%%SmartyHeaderCode:18187591be3fdbef0a2-51898231%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3b84b4e8afac1eda299b76e17703518f783fb3e4' => 
    array (
      0 => 'D:\\xampp\\htdocs\\test\\application\\views\\templates\\partials\\sidebar_left.html',
      1 => 1495001026,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18187591be3fdbef0a2-51898231',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_591be3fdde8157_20434857',
  'variables' => 
  array (
    'active_dashboard' => 0,
    'active_blog' => 0,
...
<?php if ($_valid && !is_callable('content_591be3fdde8157_20434857')) {function content_591be3fdde8157_20434857($_smarty_tpl) {?><aside id="sidebar-left" class="sidebar-circle">
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_blog']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_blog']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('blog/blog-grid');?>
">Grid</a></li>
...
">List</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('blog/blog-single');?>
">Single</a></li>
    </ul>
</li>
<!--/ End navigation - blog -->
...
">Compose mail</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('mail/mail-view');?>
">View mail</a></li>
    </ul>
</li>
<!--/ End navigation - mail -->
...
">Profile</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('pages/page-search-course');?>
">Courses</a></li>
            </ul>
        </li>
 ...
 <?php }?>">
            ...
            <ul>
                <li><a href="<?php echo base_url('errors/error-403');?>
" target="_blank">Error 403</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('pages/page-error-403');?>
">Error 403 Type 2</a></li>
                <li><a href="<?php echo base_url('errors/error-404');?>
" target="_blank">Error 404</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('pages/page-error-404');?>
">Error 404 Type 2</a></li>
                <li><a href="<?php echo base_url('errors/error-500');?>
" target="_blank">Error 500</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('pages/page-error-500');?>
">Error 500 Type 2</a></li>
        ...
        <li class="submenu">
            ...
            <ul>
                <li><a href="<?php echo base_url('account/sign-in');?>
" target="_blank">Sign In</a></li>
                <li><a href="<?php echo base_url('account/sign-up');?>
" target="_blank">Sign Up</a></li>
                <li><a href="<?php echo base_url('account/lost-password');?>
" target="_blank">Lost password</a></li>
                <li><a href="<?php echo base_url('account/lock-screen');?>
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_forms']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_forms']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('forms/form-element');?>
">Element</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('forms/form-advanced');?>
">Advanced</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('forms/form-layout');?>
">Layout</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('forms/form-validation');?>
">Validation</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('forms/form-wizard');?>
">Wizard</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('forms/form-wysiwyg');?>
">Text Editor</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('forms/form-xeditable');?>
">X-Editable</a></li>
    </ul>
</li>
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_tables']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_tables']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('tables/table-default');?>
">Default</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('tables/table-color');?>
">Color</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('tables/table-datatable');?>
">Datatable</a></li>
    </ul>
</li>
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_charts']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_charts']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('charts/chart-flot');?>
">Flot</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('charts/chart-morris');?>
">Morris</a></li>
...
">Buttons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-typography');?>
">Typography</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-panel');?>
">Panels</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-alert');?>
">Alerts</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-modal');?>
">Modals</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-video');?>
">Video <span class="label label-danger pull-right">New</span></a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-tabsaccordion');?>
">Tabs & Accordion</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-slider');?>
">Sliders</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-glyphicons');?>
">Glyphicons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-glyphicons-pro');?>
">Glyphicons PRO</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-font-awesome');?>
">Font Awesome</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-weather-icons');?>
">Weather Icons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-map-icons');?>
">Map Icons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-simple-line-icons');?>
">Simple Line Icons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('components/component-other');?>
">Other</a></li>
    </ul>
</li>
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_animate']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_animate']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('animate');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_weather']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_weather']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('widget/widget-weather');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_misc']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_misc']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('widget/widget-misc');?>
">
...
<li>
    <a href="<?php echo base_url('documentation/admin/codeigniter/live-preview-documentation.html');?>
" target="_blank">
