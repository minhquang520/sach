<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-05-19 08:24:07
         compiled from "D:\xampp\htdocs\test\application\views\templates\quanly\partials\sidebar_left.html" */ ?>
<?php /*%%SmartyHeaderCode:20759591e8c9facd3b2-40364226%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '164f68674aa47d203ffcd594af9e62f6bac50455' => 
    array (
      0 => 'D:\\xampp\\htdocs\\test\\application\\views\\templates\\quanly\\partials\\sidebar_left.html',
      1 => 1495175046,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20759591e8c9facd3b2-40364226',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_591e8c9fcd1f25_32966998',
  'variables' => 
  array (
    'active_dashboard' => 0,
    'active_blog' => 0,
...
<?php if ($_valid && !is_callable('content_591e8c9fcd1f25_32966998')) {function content_591e8c9fcd1f25_32966998($_smarty_tpl) {?><aside id="sidebar-left" class="sidebar-circle">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_dashboard']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_dashboard']->value;?>
 <?php }?>">
<a href="<?php echo base_url('quanly/dashboard');?>
">
...
">List</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/blog/blog-single');?>
">Single</a></li>
    </ul>
</li>
<!--/ End navigation - blog -->
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_mail']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_mail']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/mail/mail-inbox');?>
">Inbox</a></li>
...
">Profile</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/pages/page-search-course');?>
">Courses</a></li>
            </ul>
        </li>
 ...
 <?php }?>">
            ...
            <ul>
                <li><a href="<?php echo base_url('quanly/errors/error-403');?>
" target="_blank">Error 403</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/pages/page-error-403');?>
">Error 403 Type 2</a></li>
                <li><a href="<?php echo base_url('quanly/errors/error-404');?>
" target="_blank">Error 404</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/pages/page-error-404');?>
">Error 404 Type 2</a></li>
                <li><a href="<?php echo base_url('quanly/errors/error-500');?>
" target="_blank">Error 500</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/pages/page-error-500');?>
">Error 500 Type 2</a></li>
        ...
        <li class="submenu">
            ...
            <ul>
                <li><a href="<?php echo base_url('quanly/account/sign-in');?>
" target="_blank">Sign In</a></li>
                <li><a href="<?php echo base_url('quanly/account/sign-up');?>
" target="_blank">Sign Up</a></li>
                <li><a href="<?php echo base_url('quanly/account/lost-password');?>
" target="_blank">Lost password</a></li>
                <li><a href="<?php echo base_url('quanly/account/lock-screen');?>
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_tables']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_tables']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/tables/table-default');?>
">Default</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/tables/table-color');?>
">Color</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/tables/table-datatable');?>
">Datatable</a></li>
    </ul>
</li>
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_charts']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_charts']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/charts/chart-flot');?>
">Flot</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/charts/chart-morris');?>
">Morris</a></li>
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_components']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_components']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-grid-system');?>
">Grid System</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-button');?>
">Buttons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-typography');?>
">Typography</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-panel');?>
">Panels</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-alert');?>
">Alerts</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-modal');?>
">Modals</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-video');?>
">Video <span class="label label-danger pull-right">New</span></a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-tabsaccordion');?>
">Tabs & Accordion</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-slider');?>
">Sliders</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-glyphicons');?>
">Glyphicons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-glyphicons-pro');?>
">Glyphicons PRO</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-font-awesome');?>
">Font Awesome</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-weather-icons');?>
">Weather Icons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-map-icons');?>
">Map Icons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-simple-line-icons');?>
">Simple Line Icons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('quanly/components/component-other');?>
">Other</a></li>
    </ul>
</li>
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_animate']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_animate']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('quanly/animate');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_overview']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_overview']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('quanly/widget/widget-overview');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_social']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_social']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('quanly/widget/widget-social');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_blog']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_blog']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('quanly/widget/widget-blog');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_weather']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_weather']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('quanly/widget/widget-weather');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_misc']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_misc']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('quanly/widget/widget-misc');?>
">
...
<li>
    <a href="<?php echo base_url('quanly/documentation/admin/codeigniter/live-preview-documentation.html');?>
" target="_blank">
