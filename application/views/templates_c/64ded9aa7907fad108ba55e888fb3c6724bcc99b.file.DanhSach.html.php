<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-05-21 12:50:34
         compiled from "D:\xampp\htdocs\sach\application\views\templates\quanly\contents\DanhMuc\DanhSach.html" */ ?>
<?php /*%%SmartyHeaderCode:595859214a1651c687-63939193%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '64ded9aa7907fad108ba55e888fb3c6724bcc99b' => 
    array (
      0 => 'D:\\xampp\\htdocs\\sach\\application\\views\\templates\\quanly\\contents\\DanhMuc\\DanhSach.html',
      1 => 1495363834,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '595859214a1651c687-63939193',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_59214a16561202_31337981',
  'variables' => 
  array (
    'danhsach' => 0,
    'danhmuc' => 0,
...
<?php if ($_valid && !is_callable('content_59214a16561202_31337981')) {function content_59214a16561202_31337981($_smarty_tpl) {?><!-- Start page header -->
...
<div class="body-content animated fadeIn">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-3">
                    <a href="<?php echo base_url('quanly/danhmuc/taomoi');?>
" class="btn btn-danger btn-block btn-compose-email">Tạo danh mục</a>
                </div>
                <div class="col-md-9">
            ...
            <div class="panel rounded shadow no-overflow">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h3 class="panel-title">Thông tin danh sách danh mục</h3>
                    </div>
...
var BlankonTable = function () {
    ...
    return {
        ...
        datatable: function () {
            ...
            var products = [
                <?php  $_smarty_tpl->tpl_vars['danhmuc'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['danhmuc']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['danhsach']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['danhmuc']->key => $_smarty_tpl->tpl_vars['danhmuc']->value) {
$_smarty_tpl->tpl_vars['danhmuc']->_loop = true;
?>
                {
                    "id" : "<?php echo $_smarty_tpl->tpl_vars['danhmuc']->value->id;?>
",
                    "TenDanhMuc" : "<?php echo $_smarty_tpl->tpl_vars['danhmuc']->value->TenDanhMuc;?>
",
                    "MaDanhMucCha" : "<?php echo $_smarty_tpl->tpl_vars['danhmuc']->value->TenDanhMucCha;?>
",
                    "Slug" : "<?php echo $_smarty_tpl->tpl_vars['danhmuc']->value->Slug;?>
",
                    "Action" : '<a href="<?php echo base_url();?>
QuanLy/DanhMuc/ChinhSua/<?php echo $_smarty_tpl->tpl_vars['danhmuc']->value->id;?>
" class="btn btn-sm btn-primary btn-xs btn-push"><i class="fa fa-pencil"></i> Sửa</a>                                                    <a onclick="return confirm(\'Sẽ xóa danh mục <?php echo $_smarty_tpl->tpl_vars['danhmuc']->value->TenDanhMuc;?>
 ?\')" href="<?php echo base_url();?>
QuanLy/DanhMuc/Xoa/<?php echo $_smarty_tpl->tpl_vars['danhmuc']->value->id;?>
            ...
            filtering = function(options){
                ...
                if(options.search){
                    ...
                    items = $.grep(items, function(item){
                        ...
                        (item.TenDanhMuc.toLowerCase().search(options.search)>=0) ||
                        (item.MaDanhMucCha.toLowerCase().search(options.search)>=0) ||
