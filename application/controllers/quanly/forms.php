...
class Forms extends CI_Controller {
    ...
    public function form_element()
    {
        ...
        // Set content page
        $this->smartyci->assign('body', 'quanly/contents/forms/element.html');
    ...
    public function form_advanced()
    {
        ...
        // Set content page
        $this->smartyci->assign('body', 'quanly/contents/forms/advanced.html');
    ...
    public function form_layout()
    {
        ...
        // Set content page
        $this->smartyci->assign('body', 'quanly/contents/forms/layout.html');
    ...
    public function form_validation()
    {
        ...
        // Set content page
        $this->smartyci->assign('body', 'quanly/contents/forms/validation.html');
    ...
    public function form_wizard()
    {
        ...
        // Set content page
        $this->smartyci->assign('body', 'quanly/contents/forms/wizard.html');
    ...
    public function form_wysiwyg()
    {
        ...
        // Set content page
        $this->smartyci->assign('body', 'quanly/contents/forms/wysiwyg.html');
    ...
    public function form_xeditable()
    {
        ...
        // Set content page
        $this->smartyci->assign('body', 'quanly/contents/forms/xeditable.html');
