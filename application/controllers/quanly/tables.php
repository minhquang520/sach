...
class Tables extends CI_Controller {
    ...
    public function table_default()
    {
        ...
        // Set content page 
        $this->smartyci->assign('body', 'quanly/contents/tables/default.html');
    ...
    public function table_color()
    {
        ...
        // Set content page
        $this->smartyci->assign('body', 'quanly/contents/tables/color.html');
    ...
    public function table_datatable()
    {
        ...
        // Set content page
        $this->smartyci->assign('body', 'quanly/contents/tables/datatable.html');
